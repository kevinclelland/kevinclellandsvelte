        ...
        <div class="col-span-3 card card-hover overflow-hidden">
            <header>
                <div class="relative">
                    ...
                    <button class="absolute bottom-32 left-5 flex items-center justify-start opacity-75 hover:opacity-100" ><span class="material-icons text-sky-600 text-2xl mxr-4">verified</span> <p class="text-lg text-black font-semibold mx-2">Verified Age Grouper</p></button>
                    <h1 class="absolute font-bold text-5xl text-black bottom-20 left-5">Triathlon</h1>
...
<div class="table-container">
	...
	<table class="table table-compact table-hover">
		...
		<tbody>
				...
				<tr>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 min-w-28">02 Jun 2024</div><img src="/703logo.jpg" class="max-h-14 mx-2" alt=""><div class="mx-2 text-lg">Durban 70.3</div></div></td>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 hover:opacity-100">Upcoming</div></div></td>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 hover:opacity-100">Upcoming</div></div></td>
				</tr>
				<tr>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 min-w-28">24 Jan 2024</div><img src="/otherlogo.jpg" class="max-h-14 m-0 mx-2" alt=""><div class="mx-2 text-lg">KZN Tri Champs</div></div></td>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 hover:opacity-100">Upcoming</div></div></td>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 hover:opacity-100">Upcoming</div></div></td>
				</tr>
				<tr>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 min-w-28">19 Nov 2023</div><img src="/tinmanlogo.jpg" class="max-h-14 m-0 mx-2" alt=""><div class="mx-2 text-lg">Tinman 10km run</div></div></td>
				...
				<tr>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 min-w-28">06 Aug 2023</div><img src="/ultralogo.jpg" class="max-h-14 m-0 mx-2" alt=""><div class="mx-2 text-lg">Durban Ultra Sprint</div></div></td>
				...
				<tr>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 min-w-28">12 Mar 2023</div><img src="/tinmanlogo.jpg" class="max-h-14 m-0 mx-2" alt=""><div class="mx-2 text-lg">Tinman Challenge</div></div></td>
                ...
                <tr>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 min-w-28">30 Oct 2022</div><img src="/otherlogo.jpg" class="max-h-14 m-0 mx-2" alt=""><div class="mx-2 text-lg">WWXTRI</div></div></td>
                ...
                <tr>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 min-w-28">02 Oct 2022</div><img src="/703logo.jpg" class="max-h-14 m-0 mx-2" alt=""><div class="mx-2 text-lg">Durban 70.3</div></div></td>
                ...
                <tr>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 min-w-28">21 Aug 2022</div><img src="/tinmanlogo.jpg" class="max-h-14 m-0 mx-2" alt=""><div class="mx-2 text-lg">Tinman Challenge</div></div></td>
                ...
                <tr>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 min-w-28">20 Feb 2022</div><img src="/tinmanlogo.jpg" class="max-h-14 m-0 mx-2" alt=""><div class="mx-2 text-lg">Tinman 10km run</div></div></td>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 hover:opacity-100">1st Age-Group, 1st Overall</div></div></td>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 hover:opacity-100">00:39:35</div></div></td>
				</tr>
                <tr>
					<td><div class="flex items-center"><div class="mx-2 text-lg opacity-75 min-w-28">09 Jan 2022</div><img src="/otherlogo.jpg" class="max-h-14 m-0 mx-2" alt=""><div class="mx-2 text-lg">KZN Tri Champs</div></div></td>
